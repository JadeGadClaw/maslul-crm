# מילון מונחים — מסלול CRM

סטטוס: מילון מונחים לעיון ולשימוש בבניית מסלול CRM  
מטרה: לשמור על עברית עקבית, מודרנית וברורה בכל ממשק המשתמש.
...
| Concept | Hebrew UI term | Notes |
|---|---|---|
| Product name | מסלול CRM | השם הראשי בכל כותרת, README ומטא־דאטה |
| Demo label | מסלול CRM — דמו | למסכי כניסה או סביבת הדגמה |
| App description | מסלול CRM לניהול נסיעות, תשלומים וקבלות | תיאור קצר למטא־דאטה ולמסמכים |
| Local demo | דמו מקומי | מבהיר שהנתונים נשמרים בדפדפן |
...
| Work type | סוג עבודה | הסעה, שליחות, הובלה קלה וכד׳ |
| Taken by | נלקח ע״י | מוקדן/מנהל שקיבל את ההזמנה |
| Region | אזור | מרכז, צפון, דרום וכו׳ |
| Company | חברה | חשבון עסקי/ארגוני |
